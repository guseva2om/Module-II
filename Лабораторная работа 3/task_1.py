...
if __name__ == "__main__":
    paper_book = PaperBook(name="Преступление и наказание", author="Ф. М. Достоевский", pages=592)
    print(paper_book)
    print(repr(paper_book))

    audio_book = AudioBook(name="Искусство любить", author="Эрих Фромм", duration=52.5)
    print(audio_book)
